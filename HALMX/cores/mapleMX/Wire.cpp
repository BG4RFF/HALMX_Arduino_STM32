...
void TwoWire::begin(void)
{
  ...
  //twi_init();
#if BOARD_NR_I2C > 2 //STM32F103 series do not have three I2C ports
  if(twi == HAL_I2C3)
  {
...
void TwoWire::handleInterrupt(uint8_t TransferDirection, uint16_t AddrMatchCode)
{
    if(AddrMatchCode == defaultAddress)
    {
      ...
      if(TransferDirection == I2C_DIRECTION_TRANSMIT)
      {
        ...
        HAL_I2C_Slave_Receive_IT(&I2cHandle, &(rxBuffer[rxBufferLength]), 1, I2C_FIRST_FRAME);
      }
      else
#endif
      {
...
#endif
#if BOARD_NR_I2C > 1
    if(I2cHandle.Instance == HAL_I2C2)
    {
      HAL_NVIC_EnableIRQ(I2C2_ER_IRQn);
      HAL_NVIC_EnableIRQ(I2C2_EV_IRQn);
    }
...
#endif
#if BOARD_NR_I2C > 0 
    if (I2cHandle.Instance == HAL_I2C1)
    {
      HAL_NVIC_EnableIRQ(I2C1_ER_IRQn);
      HAL_NVIC_EnableIRQ(I2C1_EV_IRQn);
    } else
...
void HAL_I2C_SlaveRxCpltCallback(I2C_HandleTypeDef *hi2c)
{
  ...
  if(hi2c->Instance == HAL_I2C3)
  {
    ...
    HAL_I2C_Slave_Receive_IT(&(Wire2.I2cHandle), &(Wire2.rxBuffer[Wire2.rxBufferLength]), 1);
  }
  else
#endif
#if BOARD_NR_I2C > 1
    if(hi2c->Instance == HAL_I2C2)
    {
      ...
      HAL_I2C_Slave_Receive_IT(&(Wire1.I2cHandle), &(Wire1.rxBuffer[Wire1.rxBufferLength]), 1);
    }
    else
#endif
#if BOARD_NR_I2C > 0
    if (hi2c->Instance == HAL_I2C1)
    {
      ...
      HAL_I2C_Slave_Receive_IT(&(Wire.I2cHandle), &(Wire.rxBuffer[Wire.rxBufferLength]), 1);
    }
    else
#endif
    {
